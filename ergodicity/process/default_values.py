...
mean_list_default = [0.0, 0.0]  # default mean values for a multivariate correlated process
variance_matrix_default = [[1.0, 0.5], [0.5, 1.0]]  # default variance matrix for a multivariate correlated process
...
variances_default = [1, 1]  # default variances for a multivariate correlated process
correlation_matrix_default = [[1, 0.5], [0.5, 1]]   # default correlation matrix for a multivariate correlated process
